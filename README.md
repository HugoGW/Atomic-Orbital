...
The probability density array $\textit{Psi_}$$\textit{flat}$ is normalized by dividing it by its sum, creating a valid probability distribution where the sum of all probabilities is 1.
